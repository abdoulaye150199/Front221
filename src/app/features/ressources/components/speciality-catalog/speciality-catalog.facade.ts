...
@Directive()
export class SpecialityCatalogFacade {
  ...
  submitSpecialityItem(): void {
    ...
    const form: SpecialityCatalogForm = {
      ...
      domainName:
        this.isMentionSpecialityTab || this.isSpecialityTab ? this.specialityDomainName : undefined,
      ...
      durationLabel:
        this.isCycleTab || this.isSemesterTab ? this.specialityDurationLabel : undefined,
