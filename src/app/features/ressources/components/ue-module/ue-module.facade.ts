...
export class UeModuleFacade {
  ...
  get pagedUeTypeItems(): UeTypeCatalogItem[] {
    return this.paginateItems(this.ueTypeItems);
  }

  get pagedUeItems(): UeCatalogItem[] {
    return this.paginateItems(this.ueItems);
  }

  get pagedModuleItems(): ModuleCatalogItem[] {
    return this.paginateItems(this.moduleItems);
  }
  ...
  get isEditing(): boolean {
    return (
      this.editingTypeId !== null || this.editingUeId !== null || this.editingModuleId !== null
    );
  }
