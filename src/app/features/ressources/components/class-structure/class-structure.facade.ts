...
@Directive()
export class ClassStructureFacade {
  ...
  readonly classState = new PaginatedFormState<ClassCatalogItem, ClassCatalogForm>(3, () =>
    this.createClassForm(),
  );
  readonly subClassState = new PaginatedFormState<SubClassCatalogItem, SubClassCatalogForm>(5, () =>
